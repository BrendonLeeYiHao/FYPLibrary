...
export class RevenueService {
  ...
  public getGraphByYear():Observable<any>{
    return this.httpClient.get(this.SERVER_URL + "/angular/revenue/getGraphByYear.php");
  }

  public getGraphByMonth(selectedMonth:string):Observable<any>{
    return this.httpClient.post(this.SERVER_URL + "/angular/revenue/getGraphByMonth.php", {selectedMonth: selectedMonth});
  }
}
