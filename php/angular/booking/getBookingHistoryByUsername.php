<?php
    ...
    if(isset($postdata) && !empty($postdata)){
        ...
        LEFT JOIN refreshment on refreshment.RefreshmentID = booking_refreshment.RefreshmentID where booking.Username = '$username' GROUP BY booking.BookingID ORDER BY booking.BookingDate DESC";
