<?php
    ...
    // $postdata = file_get_contents("php://input");
            ...
            //ACTUAL ONE
            $sql = "SELECT MONTH(BookingDate) as monthNo, DATE_FORMAT(BookingDate, '%b') as monthName, Count(BookingDate) as occurrences from booking where BookingDate like '2023%'
